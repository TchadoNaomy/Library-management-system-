...
<body>
    <div class="sideBar">
        ...
        <nav>
            <ul>
                <li><a href="../Admin/Admin.php"><i class="fas fa-qrcode"></i> <span data-translate="dashboard">Dashboard</span></a></li>
                <li><a href="../Admin/Acount.php"><i class="fas fa-users-gear" class="icon"></i> <span data-translate="manageAccounts">Manage Accounts</span></a></li>
                <li class="active"><a href="../Admin/Book.php"><i class="fas fa-book" class="icon"></i> <span data-translate="manageBooks">Manage Books</span></a></li>
                <li><a href="../Admin/manageStock.php"><i class="fas fa-boxes-stacked" class="icon"></i> <span data-translate="manageStock">Manage Stock</span></a></li>
